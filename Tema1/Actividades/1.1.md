...
En este punto, la pila LAMP, ya seria completamente operativa, aunque para ppoder probar la configuración de la misma mediante una secuencia de comandos PHP, lo mejor es instalar un host virtual de Apache adecuado para almacenar los archivos y carpetas del sitio web.
